...
# Repo root on the host is 04-confluent-streaming/confluent/scripts/ ->
# parents[3]; but inside the
...
ROOT = _self.parents[3] if len(_self.parents) > 3 else _self.parent
