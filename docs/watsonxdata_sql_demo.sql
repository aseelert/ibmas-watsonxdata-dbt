...
--
-- The dbt path writes to dbt_demo_* schemas.
...
select
  ...
  gross_amount,
  net_amount
from iceberg_data.dbt_demo_silver.silver_sales_enriched
...
show create table iceberg_data.dbt_demo_gold.gold_daily_sales;
show create view iceberg_data.dbt_demo_gold.gold_category_performance;
