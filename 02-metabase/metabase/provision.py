...
#
#  Location  : 02-metabase/metabase/provision.py
...
WHEN TO RUN (demo flow)
  ...
  02-metabase/compose.yaml invokes this automatically. The watsonx.data
...
USAGE
  ...
  (with the same env loaded):
      python3 02-metabase/metabase/provision.py
